...
- System Biology:
    ...
    + Prof. [*Michele Caselle*](mailto:caselle@to.infn.it)  (Dept. of Fisics) **Web page**

- Machine learning & proteins data analysis:

    + Prof. [*Piero Fariselli*](mailto:piero.fariselli@unito.it) (Dept. of Medical Sciences) **Web page**
...
- Alessandri et al. rCASC: reproducible classification analysis of single-cell sequencing data. Gigascience in press. 
