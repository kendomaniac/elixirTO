...
- Genomics:
    ...
    + Prof. [*Raffaele A. Calogero*](mail.to:raffaele.calogero@unito.it) (Dept.Molecular Biotechnology and Health Sciences)

    + [*Paolo Provero*](mailto:paolo.provero@unito.it) (Dept.Molecular Biotechnology and Health Sciences)

-  Tool development e mathematical models:

    + Dr. [*Francesca Cordero*](mailto:francesca.cordero@unito.it) (Dept. of Computer Science)

    + Dr. [*Marco Beccuti*](mailto:beccuti@di.unito.it)  (Dept. of Computer Science)

- System Biology:

    + Prof. [*Michele Caselle*](mailto:caselle@to.infn.it)  (Dept. of Fisics)

- Machine learning & proteins data analysis:

    + Prof. [*Piero Fariselli*](mailto:piero.fariselli@unito.it) (Dept. of Medical Sciences)

- Epigenetics:

    + Prof. [*Salvatore Oliviero*](mailto:salvatore.oliviero@unito.it)  (Dept. of Life Sciences and System Biology)

- Human genomes datasets:

  + Prof. [*Giuseppe Matullo*](mailto:giuseppe.matullo@unito.it) (Dept. of Medical Sciences)
...
Prof. Fariselli has a long experience in macine learning

**Related pubblications**:

- [*Benvenuta et al. On the Upper Bounds of the Real-Valued Predictions. Bioinform Biol Insights. 2019*](https://www.ncbi.nlm.nih.gov/pubmed/31488948)
...
- Alessandrì et al. rCASC: reproducible classification analysis of single-cell sequencing data. Gigascience in press. 

- [*Alessandrì et al. Differential Expression Analysis in Single-Cell Transcriptomics. Methods Mol Biol 2019*](https://www.ncbi.nlm.nih.gov/pubmed/31028652)
